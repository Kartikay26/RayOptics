...
function Vector (p1,p2) {
	...
	this.toRowVector = function () { return new Matrix([[this.x,this.y,this.z]]);}
	this.toColumnVector = function () { return new Matrix([[this.x],[this.y],[this.z]]);}
}
